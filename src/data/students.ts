...
export const STUDENTS: StudentSpec[] = [
  ...
  },
  {
    ...
    subject: "Calculus — differentiation & integration",
    blurb: "Senior learning calculus (derivatives & integrals) to get ahead for data science. Loves worked formula examples.",
    bestModality: "worked formula examples with real-world applications",
    accommodations: [],
    careerGoal: "Data analyst / data scientist",
    knownSkills: "Excel, statistics, SQL, Python, and the calculus power rule",
    concepts: [
      { key: "calc.limits", label: "Limits", mastery: 0.55 },
      { key: "calc.differentiation", label: "Differentiation", mastery: 0.4, note: "mixes up the power rule and the chain rule" },
      { key: "calc.integration", label: "Integration", mastery: 0.2, note: "forgets the +C and struggles with integration by parts" },
      { key: "probability.intro", label: "Intro to probability", mastery: 0.6 },
    ],
    people: [{ key: "ms-lee", name: "Ms. Lee", role: "counselor", context: "helping Marcus plan a data-science path" }],
    goal: { key: "calc-mastery", label: "Master calculus (derivatives & integrals)", status: "progress" },
    seedTurns: [
      ["user", "I'm Marcus, a senior. I'm learning calculus right now — differentiation and integration — to get ahead for data science."],
      ["assistant", "Great goal Marcus. Calculus is the backbone of data science. Let's build derivatives and integrals solidly."],
      ["user", "I've got the power rule: the derivative of x^n is n·x^(n-1). But the chain rule keeps tripping me up."],
      ["assistant", "The power rule is locked in. We'll drill the chain rule with worked examples until it's automatic."],
      ["user", "For integration I always forget the +C, and integration by parts confuses me."],
      ["assistant", "Noted — the constant of integration and integration by parts. We'll make those second nature."],
      ["user", "I learn best from worked examples with the formulas written out, tied to real data."],
      ["assistant", "Worked formula examples it is — I'll show every step and connect it to real datasets."],
      ["user", "Ms. Lee, my counselor, is helping me plan my data-science path after graduation."],
      ["assistant", "Ms. Lee is a great partner. Calculus will strengthen your analytics foundation for that path."],
    ],
  },
];
